...
import { updateConser } from "../../../Services/ConserServices";
import Swal from "sweetalert2";
import DatePicker from "react-datepicker";
import "react-datepicker/dist/react-datepicker.css";

export default class UpdateConser extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            form: {
    ...
    componentWillReceiveProps(props) {
        ...
        if (props.data !== null) {
            ...
            form.kuota = props.data.meta.kuota;
            form.tgl_mulai = moment(props.data.meta.tgl_mulai).toDate();
            form.tgl_selsai = moment(props.data.meta.tgl_selsai).toDate();
            this.setState({ form });
        }
    }
    ...
    async submitCreate(e = null) {
        ...
        try {
            ...
            let response = await updateConser(formData);
            ...
            <>
                <Dialog
                    ...
                    <form onSubmit={this.submitCreate}>
                        <DialogTitle>Form Edit Conser</DialogTitle>

                        <DialogContent>
                            <div className="form-group">
                                <label>Nama</label>

                                <input value={this.state.form.name} type="text" className="form-control" onChange={(e) => {
                                    let form = this.state.form;
                            ...
                            <div className="form-group">
                                ...
                                <input type="number" value={this.state.form.kuota} className="form-control" onChange={(e) => {
                                    let form = this.state.form;
